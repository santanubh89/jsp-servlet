...
public class FirstServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.getWriter().append("Servlet Context Attribute:: "+getServletContext().getAttribute("username")+"<br/>");
		response.getWriter().append("Session Attribute:: "+session.getAttribute("username")+"<br/>");
		...
		pw.write("FILTER ATTRIBUTE : " + request.getAttribute("filter-attribute") + "<br/>");
