<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" errorPage="exceptionError.jsp"%>
...
<%@include file="header.jsp"%>
	...
	<%
		if (null != request.getParameter("name")) {
			...
			//pageContext.setAttribute("username1", (request.getParameter("name") + "page"), );
	...
	<a href="InitJSP">This JSP overrides init method</a>
	<br />
	<a href="UserForm">This is a User Form</a>
	<br />
	<a href="uploader">This JSP will upload a file</a>
	<br />
	<a href="FirstServlet">This is the first servlet</a>
	<br />
	<a href="Download">This Servlet downloads a file</a>
	<br />
	<a href="ExceptionServlet">This Servlet Throws Exception</a>
	<br />
